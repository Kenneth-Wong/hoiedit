...
parser.add_argument('--target_rel', type=str, default="hug")
parser.add_argument('--seed', type=int, default=42)
parser.add_argument('--model_sub_dir', type=str, default='experiments')
parser.add_argument('--data_dir', type=str, default='../ReVersion-master/reversion_benchmark_v1/')
parser.add_argument('--output_dir', type=str, default='./workdir/visualization_for_cvpr24/reversion_benchmark_v1')
...
if args.data_dir == '../ReVersion-master/reversion_benchmark_v1/':
    ...
    for k, v in records.items():
        ...
        try:
            ...
            mare_detections = gsam_model.run_single_image(os.path.join(out_dir, f"marectrl*{k}.png"),
                                                          classes=[subj_name, obj_name],
                                                          dsize=(512, 512),
                                                          de_duplicated=True,
                                                          save_name="marectrl",
